...
def tf_ssd_bboxes_encode_layer(labels,
    ...
    :param matching_threshold: Threshold for positive match with groundtruth bboxes;
    :param dtype:
    :return:
...
def tf_ssd_bboxes_encode(labels,
    ...
    """
    Encode groundruth labels and bounding boxes using SSD net anchors.
    Encoding boxes for all feature layers.

    :param labels: 1D Tensor(int64) containing groundtruth labels;
    :param bboxes: Nx4 Tensor(float) with bboxes relative coordinates;
    :param anchors: List of Numpy array with layer anchors;
    :param matching_threshold: Threshold for positive match with groundtruth bboxes;
