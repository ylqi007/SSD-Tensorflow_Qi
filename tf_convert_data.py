...
from datasets import untAerial_to_tfrecord
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'unt_aerial':
        untAerial_to_tfrecord.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
